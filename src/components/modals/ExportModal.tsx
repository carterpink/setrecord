              ...
              >
                    ...
                    {!currentSet ? (
                      ...
                      <>
                        ...
                        >
                          ...
                          >
                            Creates a Rekordbox-compatible XML file you can import back into
                            Rekordbox or copy directly to a USB drive.
                          </p>
                          <p
                            className="ss-caption"
                            style={{ color: 'var(--semantic-ok)', margin: 0 }}
                          >
                        ...
                        >
                          SetSense will check all {currentSet.tracks.length} track
                          {currentSet.tracks.length !== 1 ? 's' : ''} are compatible before
                          exporting.
                        </p>
                        {exportError && (
                          <p
                ...
                {phase === 'issues' && validationResult && (
                  <>
                    ...
                    {validationResult.cueSummary &&
                      validationResult.cueSummary.some(
                        (e) => e.hotCueCount + e.cuePointCount > 0
                      ) && (
                        <div style={{ marginBottom: 16 }}>
                          <p
                            className="ss-label"
                ...
                {phase === 'done' && exportedPath && (
                  ...
                  >
                    ...
                    >
                      Import this file into Rekordbox, or copy it to a USB drive using the buttons
                      below. Your existing Rekordbox library is not modified.
                    </p>
                          ...
                          {connectedDevices.map((device) => (
                            ...
                            >
                              ...
                              <span className="ss-body-sm">
                                {device.customName ?? device.label}
                              </span>
                              <span
                                className="ss-caption"
