/* eslint-disable react-refresh/only-export-components --
   This module exports framer-motion animation variants and re-exports `motion`/
   `AnimatePresence` — it defines no components, so the Fast Refresh
   single-export-boundary rule does not apply. */
