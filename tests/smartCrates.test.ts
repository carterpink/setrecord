...
describe('evaluateCrate — BPM rules', () => {
  ...
  it('filters by bpm range', () => {
    const crate: SmartCrate = {
      id: 'c', name: 'c', rules: [{ bpmMin: 124, bpmMax: 128 }], match: 'all',
    }
    const tracks = [
      makeTrack({ id: 'in', bpm: 126 }),
      makeTrack({ id: 'out', bpm: 132 }),
    ]
...
describe('evaluateCrate — energy rules', () => {
  it('filters by energyMin and energyMax', () => {
    const crate: SmartCrate = {
      id: 'c', name: 'c', rules: [{ energyMin: 7, energyMax: 9 }], match: 'all',
    }
    const tracks = [
...
describe('evaluateCrate — key rules', () => {
  it('exact key match', () => {
    const crate: SmartCrate = {
      id: 'c', name: 'c', rules: [{ keyExact: '8A' }], match: 'all',
    }
    const tracks = [
      makeTrack({ id: 'match', key: '8A' }),
      makeTrack({ id: 'no', key: '9B' }),
    ]
  ...
  it('keyCompatibleWith excludes clashing keys', () => {
    const crate: SmartCrate = {
      id: 'c', name: 'c', rules: [{ keyCompatibleWith: '8A' }], match: 'all',
    }
    const tracks = [
...
describe('evaluateCrate — play count rules', () => {
  it('gt operator', () => {
    const crate: SmartCrate = {
      id: 'c', name: 'c', rules: [{ playCountOp: 'gt', playCountValue: 5 }], match: 'all',
    }
    const tracks = [
      makeTrack({ id: 'a', playCount: 5 }),
      makeTrack({ id: 'b', playCount: 6 }),
    ]
  ...
  it('lte operator', () => {
    const crate: SmartCrate = {
      id: 'c', name: 'c', rules: [{ playCountOp: 'lte', playCountValue: 3 }], match: 'all',
    }
    const tracks = [
      makeTrack({ id: 'a', playCount: 3 }),
      makeTrack({ id: 'b', playCount: 4 }),
    ]
    expect(evaluateCrate(crate, tracks, NOW).map((t) => t.id)).toEqual(['a'])
  })
})
...
describe('evaluateCrate — neverPlayed rule', () => {
  it('selects only unplayed tracks', () => {
    const crate: SmartCrate = {
      id: 'c', name: 'c', rules: [{ neverPlayed: true }], match: 'all',
    }
    const tracks = [
...
describe('evaluateCrate — missingMetadata rule', () => {
  it('selects tracks missing key or bpm', () => {
    const crate: SmartCrate = {
      id: 'c', name: 'c', rules: [{ missingMetadata: true }], match: 'all',
    }
    const tracks = [
...
describe('evaluateCrate — lastPlayedOlderThan rule', () => {
  it('excludes tracks played recently', () => {
    const crate: SmartCrate = {
      id: 'c', name: 'c', rules: [{ lastPlayedOlderThanMonths: 6 }], match: 'all',
    }
    const tracks = [
...
describe('SEED_CRATES', () => {
  ...
  it('overplayed selects high-playcount tracks', () => {
    ...
    const tracks = [
      makeTrack({ id: 'op', playCount: 12 }),
      makeTrack({ id: 'ok', playCount: 5 }),
    ]
...
describe('evaluateCrate — new rule fields', () => {
  it('noCuePoints filters out tracks that have any hot cues or cue points', () => {
    const crate: SmartCrate = {
      id: 'c', name: 'c', rules: [{ noCuePoints: true }], match: 'all'
    }
    const tracks = [
  ...
  it('bpmTopPercentOfLibrary computes the threshold from the supplied library', () => {
    const crate: SmartCrate = {
      id: 'c', name: 'c', rules: [{ bpmTopPercentOfLibrary: 30 }], match: 'all'
    }
